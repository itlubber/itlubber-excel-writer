...
class ExcelWriter:
    ...
    def insert_pic2sheet(self, worksheet, fig, insert_space, figsize=(600, 250)):
        ...
        worksheet.add_image(image, insert_space)

        return start_row + figsize[0] // 50
    ...
    def insert_df2sheet(self, worksheet, data, insert_space, merge_column=None, header=True, index=False, auto_width=False):
        ...
        return (start_row + len(data) + 1, column_index_from_string(start_col))
    ...
    @staticmethod
    def itlubber_border(border, color, na_color="FFFFFF"):
        border = [None if c == na_color and b == "thin" else b for b, c in zip(border, color)]
        if len(border) == 3:
    ...
    def init_style(self, font, fontsize, theme_color):
        ...
        header_style.alignment, header_left_style.alignment, header_middle_style.alignment, header_right_style.alignment = alignment, alignment, alignment, alignment
        ...
        right_style.border = self.itlubber_border(["thin", "thin", "thin"], ["FFFFFF", theme_color, theme_color])
        ...
        merge_right_style.border = self.itlubber_border(["thin", "thin", "thin"], ["FFFFFF", theme_color, "FFFFFF"])

        self.name_styles.extend([header_style, header_left_style, header_middle_style, header_right_style, last_style, last_left_style, last_middle_style, last_right_style, content_style, left_style, middle_style, right_style, merge_style, merge_left_style, merge_middle_style, merge_right_style, ])
